...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Nested Child
    Route::delete('nested-children/destroy', 'NestedChildController@massDestroy')->name('nested-children.massDestroy');
    Route::resource('nested-children', 'NestedChildController');
});
